...
\title{\Large Developer of embedded payment \newline software solutions}
...
\cvitem{}{Software developer with a background in C, C++, Java and Lua.
Experienced with embedded payment solutions (ISO 8583, EMV contact and
contactless card processing) and on-demand maintenance. Currently working with
hardware from Verifone (Verix eVo and Engage V-OS2) and Ingenico (Telium 2 and
Telium Plus) manufacturers.}

\vspace{\baselineskip}

\cvitem{}{Most relevant projects:}
...
\cvitem{\textbf{Redeflex}:}{Ingenico Telium 2 and Tetra; Verifone Verix and
Engage.}
...
\tlcventry{2017}{0}
{\textit{\small{(Current)}} System Analyst}
...
\cvitem{-}{Familiar with embedded APIs of parallelism and asynchronism,
