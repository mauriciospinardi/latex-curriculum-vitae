...
\usepackage[bottom=2.75cm,scale=0.75,top=2.75cm]{geometry} % TODO: review the workaround of using 2.75cm instead of 3cm
                                                           % for both 'bottom' and 'top' parameters
...
\cvitem{\textbf{Programming Languages}}
{
    \begin{tabular}{p{25mm}p{\linewidth}}
        ...
        \textbf{Java} & \progressbar{0.75}\protect\\
        \textbf{Kotlin} & \progressbar{0.45}\protect\\
        \textbf{Lua} & \progressbar{0.50}\protect\\
        \textbf{Python} & \progressbar{0.20}\protect\\
        \textbf{Ruby} & \progressbar{0.35}
    \end{tabular}
}
