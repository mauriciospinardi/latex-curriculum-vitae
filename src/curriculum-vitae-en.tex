...
\title{\Large Embedded payment software\protect\\developer}
...
hardware from Verifone and Ingenico.

\vspace{\baselineskip}

\hspace{1.25cm} Most relevant projects as developer:

\vspace{\baselineskip}

\cvitem{\textbf{PagBem}}{Verifone Verix.}
\cvitem{\textbf{SafraPay}}{Ingenico Tetra; Verifone Verix.}
\cvitem{\textbf{Rede}}{Ingenico Telium 2 and Tetra; Verifone Verix and Engage.}
\cvitem{\textbf{ABECS}}{Ingenico Telium 2 and Tetra; Verifone Engage.}

\section{Professional background}
% --------------------------------------

\cvitem{}{Verifone do Brasil Ltda}
\small{\cvitem{Since 2020}{\textbf{Outsourced service provider}}}

\vspace{\baselineskip}

\cvitem{}{SETIS Automação e Sistemas Ltda}
\cvitem{Since 2017}{\textbf{System Analyst}}
\cvitem{}{\small{\emph{Embedded payment software development and maintenance.}}}
\cvitem{2016}{\textbf{Intern}}

\vspace{\baselineskip}

\cvitem{}{Federal University of São Carlos - Campus Sorocaba}
\cvitem{2014}{\textbf{Object Oriented Programming Teaching Assistant}}
...
\cvitem{-}{Familiar with embedded APIs of parallelism and asynchronism, PThreads, OpenMP and MPI.}
